...
var saveButton = document.querySelector('.students-form__button--save');
var addButton = document.querySelector('.students-form__button--add');
var studentForm = document.getElementById('students-form');
var studentsGroup = document.getElementById("students-table__body");
var downloadBtn = document.querySelector(".students-table__download-btn");
...
function _renderTable() {
  _renderTable = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var source, template, _yield$axios$get, data, formattedData;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          source = document.getElementById('students-table__body-template').innerHTML.trim();
          template = Handlebars.compile(source);
          _context.prev = 2;
          _context.next = 5;
          return _axios.default.get('http://localhost:3000/students');
        case 5:
          ...
          studentsGroup.innerHTML = formattedData.map(function (student) {
...
function _createStudent() {
  _createStudent = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(obj) {
    var newStudent;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _axios.default.post('http://localhost:3000/students', obj);
        case 3:
        ...
        case 8:
          ...
          console.error("Помилка створення студента:", _context2.t0);
        case 11:
          formCleaner();
        case 12:
        case "end":
...
function editElement(_x2) {
  return _editElement.apply(this, arguments);
} // DELETE
function _editElement() {
  _editElement = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id) {
    var _yield$axios$get2, data, student;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          ...
          console.error("\u0421\u0442\u0443\u0434\u0435\u043D\u0442 \u0437 ID ".concat(id, " \u043D\u0435 \u0437\u043D\u0430\u0439\u0434\u0435\u043D\u0438\u0439"));
        ...
        case 9:
          ...
          saveButton.onclick = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
            var index, url, endpoint, newStudent, response;
              ...
              while (1) switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  newStudent = {
                    ...
                    skills: document.getElementById('skills').value.split(',').map(function (skill) {
                      return skill.trim();
                    }),
                  ...
                  _context3.prev = 5;
                  _context3.next = 8;
                  return _axios.default.put("".concat(url, "/").concat(endpoint, "/").concat(id), newStudent);
                case 8:
                ...
                case 13:
                  ...
                  console.error("Не вдалося оновити студента:", _context3.t0);
                case 16:
        ...
        case 18:
          ...
          console.error("Помилка редагування:", _context4.t0);
        case 21:
        case "end":
...
function deleteElement(_x3) {
  return _deleteElement.apply(this, arguments);
}
function _deleteElement() {
  _deleteElement = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(id) {
    var _yield$axios$get3, data, index, url, endpoint, response;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 3:
          ...
          endpoint = 'students';
          _context5.next = 11;
          return _axios.default.delete("".concat(url, "/").concat(endpoint, "/").concat(id));
        case 11:
        ...
        case 16:
          ...
          console.error("Помилка видалення:", _context5.t0);
        case 19:
        case "end":
...
document.getElementById("students-table__body").addEventListener('click', function (event) {
  var editButton = event.target.closest('.students-table__body-btn--edit');
  var deleteBtn = event.target.closest('.students-table__body-btn--delete');
  if (editButton) {
...
function downloadList() {
  return _downloadList.apply(this, arguments);
}
function _downloadList() {
  _downloadList = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    var _yield$axios$get4, data, jsonStudents, parseDataStudents;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 3:
          ...
          if (data.length > 0) {
            jsonStudents = JSON.stringify(data, null, 2);
            downloadJSON("Students.json", jsonStudents);
            try {
              parseDataStudents = JSON.parse(jsonStudents);
        ...
        case 8:
          ...
          console.error("Помилка завантаження:", _context6.t0);
        case 11:
        case "end":
